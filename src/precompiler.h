...
class Precompiler {
 public:
  Precompiler(vector<string>& every_line);//constructor por parametro

  friend std::ostream& operator<<(std::ostream& out, Precompiler& variable);//sobrecarga del operador de extraccion
